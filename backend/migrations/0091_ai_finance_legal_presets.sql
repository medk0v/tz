...
ALTER TABLE ai_profiles
    ...
    ADD CONSTRAINT ai_profiles_preset_key_check
        CHECK (preset_key IN ('coordinator', 'sales', 'finance', 'legal', 'support', 'operations', 'quality', 'hr', 'universal'));

-- Add finance and legal to existing and future projects without changing existing presets.
